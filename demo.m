...
% To create Raster Plot for each stimuli and cell
% figure
% for iStim = 1:n_stimuli
%     for iTrial=1:n_trials
%         SpikeCount = counts{iStim,1}{iTrial,1};
%         imagesc(SpikeCount),hold on
%         title(sprintf('Stimulus %u, Trial %u',iStim,iTrial));
%         drawnow
%         colorbar
%         pause;
%     end
