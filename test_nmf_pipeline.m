...
% load('C:\Users\Freeman\Documents\GitHub\NMF_Fun\SimulatedData_201803091512.mat');
% poolobj = parpool(10);
...
for iC = 1:nCoding
    ...
    for iN = 1:nNoise
        ...
        for iXV = 1:Opt.nXVAL
            ...
            [xvNMF{iXV,4},minSQE(iXV), K_cv(iXV), xvNMF{iXV,1}] = select_k(X_train,groups_train,X_test,groups_test,Opt);
